package net.openmob.mobileimsdk.android.demo.client;
...
import net.openmob.mobileimsdk.android.demo.client.core.*;
import net.openmob.mobileimsdk.android.demo.client.event.ChatBaseEvent;
import net.openmob.mobileimsdk.android.demo.client.event.ChatTransDataEvent;
import net.openmob.mobileimsdk.android.demo.client.event.MessageQoSEvent;
