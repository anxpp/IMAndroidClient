...
import net.openmob.mobileimsdk.android.demo.client.message.MessageFactory;
import net.openmob.mobileimsdk.android.demo.client.message.MessageType;
import net.openmob.mobileimsdk.android.demo.client.message.server.ErrorResponse;
import net.openmob.mobileimsdk.android.demo.client.message.server.LoginInfoResponse;
...
public class MessageReceiver {
    ...
    private static class MessageHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            try {
                net.openmob.mobileimsdk.android.demo.client.message.Message pFromServer =
                ...
                switch (pFromServer.getType()) {
                    ...
                    case MessageType.Server.FROM_SERVER_TYPE_OF_RESPONSE$LOGIN: {
                        ...
                        if (loginInfoRes.getCode() == 0) {
                            ...
                            KeepAliveDaemon.getInstance(this.context).setNetworkConnectionLostObserver((observable, data) -> {
        ...
        private void sendReceivedBack(final net.openmob.mobileimsdk.android.demo.client.message.Message pFromServer) {
