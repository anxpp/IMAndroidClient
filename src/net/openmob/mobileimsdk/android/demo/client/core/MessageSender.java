...
import net.openmob.mobileimsdk.android.demo.client.message.CharsetHelper;
...
import net.openmob.mobileimsdk.android.demo.client.message.StatusCode;
import net.openmob.mobileimsdk.android.demo.client.utils.UDPUtils;
