package net.openmob.mobileimsdk.android.demo.client.message;

import com.google.gson.Gson;
import net.openmob.mobileimsdk.android.demo.client.message.client.LoginInfo;
import net.openmob.mobileimsdk.android.demo.client.message.client.PKeepAlive;
import net.openmob.mobileimsdk.android.demo.client.message.server.ErrorResponse;
import net.openmob.mobileimsdk.android.demo.client.message.server.KeepAliveResponse;
